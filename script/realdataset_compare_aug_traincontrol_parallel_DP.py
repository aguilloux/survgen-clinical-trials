        ...
        for eps in list_epsilon:
            ...
            for generator_name in generators_sel:
                ...
                for f in os.listdir(best_param_dir):
                    if (f.endswith('.json') & ("traincontrol_" + name_config + "_aug_Ncontrol1%3_ntrials{}_{}_{}_DP_eps{}".format(n_trials, optuna_version_name, generator_name, int(eps)) in f)):
                        best_param_file = f
            ...
            save_res_dir = parent_path + "/dataset/" + dataset_name + "/metric_results_DP_" + optuna_version_name
