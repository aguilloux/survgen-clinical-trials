...
def run(MC_id):
    ...
    # optuna_version_name = "ExMetrics1_seedData{}_seedHPO{}".format(0, 11)
    optuna_version_name = "ValLoss_seedData{}_seedHPO{}".format(0, 11)
    ...
    for generator_name in generators_sel:
        ...
        best_params_file = os.path.join(base_path, "optuna_results", "best_params_{}_ntrials{}_{}_{}.json".format(name_config, n_trials, optuna_version_name, generator_name))
    ...
    results.to_csv(f"{parent_path}/dataset/{dataset_name}/results_{optuna_version_name}_n_samples_{n_samples}_n_features_bytype_{n_features_bytype}_MC_{MC_init}to{MC_final}.csv")
