...
def run(generator_name):
    ...
    # Save the data
    dataset_name = "Simulations_indep_trainfull"
    ...
    if generator_name in ["HI-VAE_lognormal", "HI-VAE_weibull", "HI-VAE_piecewise", "HI-VAE_weibull_prior", "HI-VAE_piecewise_prior"]:
        ...
        condition = {'var': 'treatment_0', 'value': 1.0, 'n_samples': control.shape[0]}  # Condition on the control group
        ...
        condition = {'var': 'treatment', 'value': 0.0, 'n_samples': control.shape[0]}
