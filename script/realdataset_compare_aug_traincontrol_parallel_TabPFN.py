    ...
    for d, perc_control in enumerate(list_n_samples_control):
        ...
        for generator_name in generators_sel:
            ...
            for j in range(n_generated_dataset):
                ...
                df_gen_control_j.to_csv(save_gen_data_dir + "df_gen_control_" + "aug_Ncontrol{}%3_".format((d+1)) + generator_name  + "_" + optuna_version_name + "_{}_ext.csv".format(j), index=False)
        ...
        save_res_dir = parent_path + "/dataset/" + dataset_name + "/metric_results_TabPFN"
